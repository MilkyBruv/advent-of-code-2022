...
class Pair():
    ...
    def get_ranges(self) -> int:
        ...
        if self.left[0] in range(self.right[0], self.right[1] + 1) or \
        self.left[1] in range(self.right[0], self.right[1] + 1) or \
        self.right[0] in range(self.left[0], self.left[1] + 1) or \
        self.right[1] in range(self.left[0], self.left[1] + 1):
